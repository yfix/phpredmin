...
<head>
    ...
    <script type="text/javascript" src="<?=$this->router->media_url?>/js/redmin/main.js"></script>
    <script type="text/javascript" src="<?=$this->router->media_url?>/js/redmin/modal.js"></script>
